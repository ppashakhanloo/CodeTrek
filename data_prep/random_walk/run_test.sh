...
python gen_stubs_exception.py $gv $edb_path AssertionError $stub_file"_g" graphs
echo "prog_cls, graphs:" $?
python gen_stubs_exception.py $gv $edb_path AssertionError $stub_file"_w" walks
echo "prog_cls, walks:" $?
