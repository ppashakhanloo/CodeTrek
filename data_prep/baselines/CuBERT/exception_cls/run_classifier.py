...
class ExceptionProcessor(DataProcessor):
  def get_train_examples(self, data_dir):
  ...
  def get_labels(self):
    return ['ValueError', 'KeyError', 'AttributeError', 'TypeError', 'OSError',
            ...
            'UnicodeDecodeError', 'NotImplementedError', 'ValidationError', 'ObjectDoesNotExist', 'NameError']
